const ACTION_DEFINITIONS = Object.freeze({
  ...
  LOCATION_CONFIRM: Object.freeze({
    actionId: "location.confirm",
    type: "LOCATION_CONFIRM",
    family: "navigation",
    label: "Conferma posizione",
    controlledVoiceAliases: [],
  }),
  LOCATION_CORRECT: Object.freeze({
    actionId: "location.correct",
    type: "LOCATION_CORRECT",
    family: "navigation",
    label: "Aggiorna posizione",
    controlledVoiceAliases: [],
  }),
  VISIT_STOP_SELECT: Object.freeze({
    actionId: "visit.stop.select",
    type: "VISIT_STOP_SELECT",
    family: "progress",
    label: "Vai alla tappa",
    controlledVoiceAliases: [],
  }),
  NAVIGATION_RETURN_TO_VISIT: Object.freeze({
    actionId: "navigation.return_to_visit",
    type: "NAVIGATION_RETURN_TO_VISIT",
    family: "navigation",
    label: "Torna alla visita",
    controlledVoiceAliases: ["torna alla visita", "riprendi la visita"],
  }),
