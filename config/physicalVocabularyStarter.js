...
const PLACE_TYPES = Object.freeze([
  base({ key: "room", label: "Sala", description: "Spazio visitabile o ambiente espositivo.", aliases: ["stanza", "ambiente", "galleria"], semanticRefs: [semantic("openstreetmap-tag", "indoor=room")] }),
  base({ key: "entrance", label: "Ingresso", description: "Punto ordinario di accesso alla sede.", aliases: ["entrata", "accesso"], semanticRefs: [semantic("openstreetmap-tag", "entrance=yes")] }),
  base({ key: "exit", label: "Uscita", description: "Punto ordinario di uscita dalla sede.", aliases: ["uscita principale"], semanticRefs: [semantic("openstreetmap-tag", "entrance=exit")] }),
  base({ key: "emergency_exit", label: "Uscita di emergenza", description: "Uscita destinata alle situazioni di emergenza.", aliases: ["uscita di sicurezza"], semanticRefs: [semantic("openstreetmap-tag", "emergency=exit")] }),
  base({ key: "toilets", label: "Servizi igienici", description: "Area con servizi igienici per i visitatori.", aliases: ["toilette", "bagno", "bagni", "wc", "servizi"], semanticRefs: [semantic("openstreetmap-tag", "amenity=toilets")] }),
  base({ key: "cafe", label: "Bar / Caffetteria", description: "Punto di ristoro interno o collegato alla sede.", aliases: ["bar", "caffetteria", "cafe"], semanticRefs: [semantic("openstreetmap-tag", "amenity=cafe")] }),
  base({ key: "shop", label: "Negozio / Bookshop", description: "Spazio di vendita della sede.", aliases: ["negozio", "bookshop", "gift shop"], semanticRefs: [semantic("openstreetmap-tag", "shop=gift", "close")] }),
  base({ key: "information_point", label: "Punto informazioni", description: "Punto di assistenza e informazione per i visitatori.", aliases: ["info point", "informazioni", "reception"], semanticRefs: [semantic("openstreetmap-tag", "tourism=information")] }),
  base({ key: "cloakroom", label: "Guardaroba", description: "Spazio per il deposito temporaneo di abiti e oggetti.", aliases: ["guardaroba", "deposito borse"], semanticRefs: [semantic("openstreetmap-tag", "amenity=cloakroom")] }),
  base({ key: "elevator", label: "Ascensore", description: "Punto di accesso a un ascensore.", aliases: ["elevatore", "lift"], semanticRefs: [semantic("openstreetmap-tag", "highway=elevator")] }),
  base({ key: "stairs", label: "Scale", description: "Punto di accesso a una scala tra livelli.", aliases: ["scala", "gradini", "scalinata"], semanticRefs: [semantic("openstreetmap-tag", "highway=steps")] }),
  base({ key: "waiting_area", label: "Area di attesa", description: "Spazio in cui sostare in attesa.", aliases: ["attesa", "zona di attesa"], semanticRefs: [semantic("openstreetmap-tag", "amenity=lounge", "close")] }),
...
const PHYSICAL_ATTRIBUTES = Object.freeze([
  { ...base({ key: "has_steps", label: "Presenza di gradini", description: "Indica se il tratto include uno o più gradini.", aliases: ["gradini", "scale"], semanticRefs: [semantic("openstreetmap-tag", "step_count=*")] }), dataType: "boolean", unit: null, options: [], appliesTo: "connection" },
  { ...base({ key: "step_free", label: "Accessibile senza gradini", description: "Indica un passaggio percorribile senza superare gradini.", aliases: ["senza gradini", "accesso a raso"], semanticRefs: [semantic("openstreetmap-tag", "wheelchair=yes", "close")] }), dataType: "boolean", unit: null, options: [], appliesTo: "both" },
  ...
  { ...base({ key: "narrow_passage", label: "Passaggio stretto", description: "Indica che il tratto presenta una strozzatura significativa.", aliases: ["strettoia", "passaggio angusto"], semanticRefs: [semantic("openstreetmap-tag", "width=limited", "close")] }), dataType: "boolean", unit: null, options: [], appliesTo: "connection" },
  ...
  { ...base({ key: "obstacles", label: "Presenza di ostacoli", description: "Indica ostacoli rilevanti per la percorribilità.", aliases: ["ostacoli", "impedimenti"], semanticRefs: [semantic("openstreetmap-tag", "obstacle=*")] }), dataType: "boolean", unit: null, options: [], appliesTo: "both" },
