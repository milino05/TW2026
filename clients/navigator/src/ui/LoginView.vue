...
<template>
  <main class="login-page">
    ...
    <section class="login-panel" aria-labelledby="login-title">
      ...
      <h1 id="login-title">Inizia la tua visita</h1>
      <p v-if="platformConfig?.branding.subtitle" class="login-subtitle">{{ platformConfig.branding.subtitle }}</p>
      <form @submit.prevent="submit">
        ...
        <button class="login-submit" type="submit" :disabled="busy">{{ busy ? "Accesso…" : "Accedi" }}</button>
      </form>
