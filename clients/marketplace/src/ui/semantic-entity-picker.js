...
export class ArtAroundSemanticEntityPicker extends HTMLElement {
  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `<style>
      :host{display:block}.resolver{display:grid;gap:.8rem;padding:.9rem;border:1px solid var(--line);border-radius:var(--radius-md);background:var(--sage-50);color:var(--ink-950)}.resolver h4{margin:0;color:var(--ink-950)}.resolver p{margin:.15rem 0;color:var(--sage-600)}.resolver form{display:flex;gap:.5rem;align-items:end;flex-wrap:wrap}.resolver label{display:grid;gap:.3rem;flex:1;min-width:12rem;color:var(--ink-800);font-size:.82rem;font-weight:700}.resolver input,.resolver select,.resolver textarea{box-sizing:border-box;width:100%;padding:.62rem;border:1px solid var(--line-strong);border-radius:var(--radius-sm);background:var(--surface);color:var(--ink-950);font:inherit}.resolver input:focus,.resolver select:focus,.resolver textarea:focus{outline:3px solid rgba(100,28,59,.25);outline-offset:1px;border-color:var(--ink-800)}.resolver button{padding:.6rem .76rem;border:0;border-radius:var(--radius-sm);background:var(--ink-900);color:#fff;font:inherit;font-weight:750;cursor:pointer}.resolver button:hover:not(:disabled){background:var(--ink-800)}.resolver button:disabled{cursor:wait;opacity:.6}.resolver .button-secondary{border:1px solid var(--line-strong);background:var(--surface);color:var(--ink-800)}.unified-search{padding:.35rem;border-radius:var(--radius-sm);background:var(--sage-100)}.search-explanation{font-size:.8rem}.result-group{display:grid;gap:.5rem}.result-heading{display:flex;align-items:end;justify-content:space-between;gap:.5rem}.result-heading>div{display:grid;gap:.12rem}.result-source{display:block;color:var(--ink-800);font-size:.7rem;font-weight:850;letter-spacing:.07em;text-transform:uppercase}.result-count{display:grid;place-items:center;min-width:1.8rem;min-height:1.8rem;border-radius:999px;background:var(--sage-100);color:var(--ink-800);font-size:.75rem;font-weight:850}.resolver-results{display:grid;gap:.45rem;padding:0;margin:0;list-style:none}.resolver-results li{display:flex;align-items:center;justify-content:space-between;gap:.7rem;padding:.72rem;border:1px solid var(--line);border-radius:var(--radius-sm);background:var(--surface)}.resolver-results li>div{min-width:0}.resolver-results small,.resolver-results span{display:block}.identity{margin-top:.25rem;font:700 .72rem/1.2 ui-monospace,monospace;color:var(--sage-700)}.query-match{margin-top:.28rem;color:var(--sage-600);font-size:.72rem;font-weight:750}.bound{margin-top:.3rem;padding:.28rem .38rem;border-radius:.35rem;background:var(--sage-100);color:var(--ink-800);font-size:.75rem;font-weight:800}.result-actions,.continue-search,.provider-retry{display:flex;align-items:center;justify-content:space-between;gap:.65rem;padding:.6rem;border-radius:var(--radius-sm);background:var(--sage-100);font-size:.78rem}.continue-search>div,.provider-retry>div{display:grid;gap:.1rem}.continue-search small,.provider-retry span{color:var(--sage-600)}.provider-retry{border:1px solid var(--amber-200);background:var(--amber-100)}.resolver-feedback{padding:.6rem;border-radius:var(--radius-sm);background:var(--sage-100)}.resolver-error{background:var(--red-100);color:var(--red-700)}.manual-create{display:grid;gap:.55rem;padding:.75rem;border-left:3px solid var(--ink-800);background:var(--sage-100)}.manual-create form{display:grid}.attribution{font-size:.72rem;color:var(--ink-800)}@media(max-width:560px){.resolver{padding:.72rem}.resolver form,.resolver-results li,.result-actions,.continue-search,.provider-retry{align-items:stretch;flex-direction:column}.resolver button{width:100%}.resolver label{min-width:0}}
