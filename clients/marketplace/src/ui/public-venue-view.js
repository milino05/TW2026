...
export class ArtAroundPublicVenueView extends HTMLElement {
  ...
  onClick = (event) => {
    ...
    if (target?.closest("[data-organization]")) navigate(`/organizations/public?organizationId=${encodeURIComponent(this.data.organization.id)}`);
  };
  ...
  render() {
    ...
    const { venue, organization, targets } = this.data;
