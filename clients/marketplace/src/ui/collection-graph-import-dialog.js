...
export class ArtAroundCollectionGraphImportDialog extends HTMLElement {
  ...
  renderSources() {
    ...
    return `${this.subviewHeading("Aggiungi sorgente", { back: true })}
      ...
      <div class="operations"><button type="button" data-modal-confirm data-attach-source ${!this.selectedGraph || this.busy ? "disabled" : ""}>${this.busy ? "Aggiunta…" : "Aggiungi sorgente"}</button></div>`;
  }
