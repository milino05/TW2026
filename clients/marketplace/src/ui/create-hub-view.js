...
export class ArtAroundCreateHubView extends HTMLElement {
  ...
  async load() {
    ...
    try {
      const [workspaceContext, preflight, venues] = await Promise.all([
