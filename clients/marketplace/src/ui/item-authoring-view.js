...
export class ItemAuthoringView extends HTMLElement {
  ...
  venueId = params().get("venueId") || null;
  ...
  renderProgress() {
    const stages = [[1, "Di cosa parla"], [2, "Info generali"], [3, "Regole e testi"], [4, "Collegamenti"], [5, "Controllo finale"]];
  ...
  representationStyles() {
    return `<style>
      ...
      .physical-intent{display:grid;grid-template-columns:auto 1fr;gap:.7rem;align-items:start;padding:.85rem;border:1px solid #b9ccc3;border-radius:.8rem;background:#f1f6f3}.physical-intent input{margin-top:.2rem}.physical-intent span{display:grid;gap:.2rem}.physical-intent small{color:#60706a;font-weight:450}
      ...
      /* Museum theme: keep the authoring workflow aligned with the Marketplace palette. */
      .authoring-page>.authoring-header{margin-bottom:.1rem;padding:clamp(1.25rem,3vw,2rem);border:1px solid var(--line);border-radius:var(--radius-xl);background:linear-gradient(135deg,var(--surface),var(--sage-50));box-shadow:var(--shadow-sm)}
      .authoring-header .eyebrow{color:var(--ink-800)}.authoring-header h1{color:var(--ink-950)}.authoring-header p{color:var(--sage-600)}
      .authoring-progress button{border-color:var(--line);background:var(--surface);color:var(--ink-800);box-shadow:var(--shadow-sm)}
      .authoring-progress button:hover:not(:disabled){border-color:var(--sage-400);background:var(--sage-50);color:var(--ink-950)}
      .authoring-progress li[data-current="true"] button,.authoring-progress li[data-current="true"] button:hover:not(:disabled){border-color:var(--ink-900);background:var(--ink-900);color:#fff}
      .authoring-progress li[data-complete="true"]:not([data-current="true"]) button{border-color:var(--sage-300);background:var(--sage-100);color:var(--ink-900)}
      .authoring-progress button>span{background:var(--sage-100);color:var(--ink-800)}.authoring-progress li[data-current="true"] button>span{background:var(--surface);color:var(--ink-900)}.authoring-progress li[data-complete="true"]:not([data-current="true"]) button>span{background:var(--ink-900);color:#fff}.authoring-progress button:disabled{color:var(--sage-600)}
      .step-number{background:var(--ink-900);color:#fff}.wizard-step .eyebrow{color:var(--sage-700)}
      .selection-signal-fieldset,.subject-summary,.context-box,.selection-summary,.readiness,.issue-panel,.workflow-panel,.review-grid article,.representation-editor,.representation-editor--collapsed,.text-empty-state,.item-media-card,.review-texts--empty,.connection-empty-state,.connection-editor{border-color:var(--line);background:var(--sage-50);color:var(--ink-950)}
      .selection-signal-fieldset legend,.representation-choice,.representation-summary dd{color:var(--ink-800)}.selection-signal-card,.representation-choice summary,.representation-choice__option,.representation-summary>div,.review-media,.connection-target-results article,.connection-search-empty,.connection-list>article{border-color:var(--line);background:var(--surface);color:var(--ink-950)}
      .selection-signal-card[data-selected="true"],.representation-editor[data-selected="true"],.connection-target-results article[data-selected="true"]{border-color:var(--sage-400);background:var(--sage-100);box-shadow:0 0 0 2px rgba(100,28,59,.08)}
      .representation-editor:focus,.representation-choice details[open]>summary,.private-success-dialog:focus{outline-color:rgba(100,28,59,.25);border-color:var(--ink-800);box-shadow:0 0 0 3px rgba(100,28,59,.12)}
      .representation-editor--collapsed:hover{border-color:var(--sage-400);background:var(--sage-100);box-shadow:var(--shadow-sm)}.representation-choice__options{border-color:var(--line);background:var(--surface);box-shadow:var(--shadow-md)}.representation-choice__option:hover:not(:disabled),.representation-choice__option[aria-selected="true"]{background:var(--sage-100);color:var(--ink-900)}
      .selection-signal-main small,.selection-signal-weight,.selection-summary small,.representation-summary dt,.text-empty-state p,.media-rights,.media-notice,.item-media-editor small,.review-grid article span,.review-texts article header span,.review-media--empty,.review-texts--empty,.connection-empty-state p,.connection-target-results small,.selected-connection-target small,.connection-relation-help p,.connection-relation-help small,.connection-direction,.connection-copy>p,.note{color:var(--sage-600)}
      .text-empty-state__icon,.connection-empty-state>span,.connection-direction>span,.connection-target-placeholder{background:var(--sage-100);color:var(--ink-800)}.media-placeholder{border-color:var(--line-strong);background:var(--sage-100);color:var(--sage-700)}.item-media-card figure,.review-media figure{border-color:var(--line);background:var(--sage-100)}.media-links a{color:var(--ink-800)}.item-media-editor,.connection-target-picker{border-color:var(--line)}
      .selected-connection-target{background:var(--sage-100)}.selected-connection-target>span{background:var(--ink-900);color:#fff}.connection-relation-help{border-left-color:var(--ink-800);background:var(--sage-100)}.connection-advanced,.membership-fieldset,.technical-details{border-color:var(--line-strong)}.connection-meta span{background:var(--sage-100);color:var(--sage-700)}.connection-note{background:var(--sage-50);color:var(--sage-700)!important}
      .private-success-overlay{background:rgba(36,21,29,.7)}.private-success-dialog{border-color:var(--line);background:var(--surface);box-shadow:var(--shadow-lg);color:var(--ink-950)}.private-success-icon{background:var(--sage-100);color:var(--ink-900)}
