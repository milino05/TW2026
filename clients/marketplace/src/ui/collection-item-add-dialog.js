...
export class ArtAroundCollectionItemAddDialog extends HTMLElement {
  ...
  async addItem(itemId) {
    ...
    try {
      ...
      this.dispatchEvent(new CustomEvent("editorial-content-changed", { bubbles: true, detail: { itemId } }));
      await this.load();
    } catch (error) {
