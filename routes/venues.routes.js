...
const navigatorConfigController = require("../controllers/navigatorVenueConfig.controller");
...
const assetId = validateObjectIdParam("assetId");
...
router.get("/navigator-assets/:assetId", assetId, navigatorConfigController.navigatorAsset);
...
router.get("/venues/:venueId/navigator-config", requireAuth, venueId, navigatorConfigController.getVenueConfig);
router.put("/venues/:venueId/navigator-config", requireAuth, venueId, navigatorConfigController.updateVenueConfig);
router.post("/venues/:venueId/navigator-config/assets", requireAuth, venueId, navigatorConfigController.uploadVenueAsset);
router.post("/venues/:venueId/navigator-config/copy", requireAuth, venueId, navigatorConfigController.copyVenueConfig);
