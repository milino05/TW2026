...
test("authoring e commerce mantengono feature parity strutturale", () => {
  ...
  for (const term of ["Informazioni principali", "Contenuti", "Tappe", "Impostazioni", "Percorso", "Riepilogo e pubblicazione", "data-open-visit-content", "data-add-stop"]) assert.match(visitEditor, new RegExp(term));
