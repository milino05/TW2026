...
test("authoring e commerce mantengono feature parity strutturale", () => {
  for (const term of ["Di cosa parla", "Controllo e pubblicazione", "data-new-edition", "data-content-space-id", "data-add-representation"]) assert.match(itemEditor, new RegExp(term));
