  ...
  return {
    ...
    revision: revision ? {
      ...
      relationTypes: (revision.relationTypes || []).map((entry) => ({
        ...
        userIntents: entry.userIntents || [],
        targetSelectionSignals: entry.targetSelectionSignals || [],
        reverse: entry.reverse ? {
          label: entry.reverse.label || "",
          description: entry.reverse.description || "",
          userIntents: entry.reverse.userIntents || [],
          targetSelectionSignals: entry.reverse.targetSelectionSignals || [],
        } : null,
