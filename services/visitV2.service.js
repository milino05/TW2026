...
const REVISION_FIELDS = ["title", "description", "contentSources", "editorialSources", "contentEntries", "visitAnchors", "groupSessionDefaults", "quiz", "presentationBaseline", "logistics"];
...
async function createVisitV2({ payload, actorUserId }) {
  ...
  try {
    revision = await VisitRevisionV2.create({
      ...
      groupSessionDefaults: normalized.groupSessionDefaults || { preferredJoinAlias: null },
