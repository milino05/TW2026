...
const PlanChangeProposalSchema = new Schema({
  ...
  reason: { type: String, enum: ["ahead_of_schedule", "behind_schedule", "manual_request", "refocus_future", "extend_visit", "parameter_change", "route_only"], required: true },
  ...
  currentEntryIndex: { type: Number, min: 0, required: true },
