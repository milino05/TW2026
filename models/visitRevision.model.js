...
const VisitRevisionSchema = new Schema(
  {
    ...
    estimatedContentSeconds: { type: Number, min: 0, default: 0 },
    estimatedObservationSeconds: { type: Number, min: 0, default: 0 },
    estimatedLogisticsSeconds: { type: Number, min: 0, default: 0 },
    estimatedTotalSeconds: { type: Number, min: 0, default: 0 },
    logistics: {
      preVisitNotes: { type: [{ type: String, trim: true }], default: [] },
      transitions: { type: [LogisticsTransitionSchema], default: [] },
    },
