...
const RouteHintSchema = new Schema({
  fromTargetEntryId: { type: Schema.Types.ObjectId, required: true },
  toTargetEntryId: { type: Schema.Types.ObjectId, required: true },
  ...
  plannedPath: { type: [Schema.Types.ObjectId], default: [] },
...
VisitRevisionSchema.index({ "contentEntries.itemId": 1 });
