...
const VenueTargetReleaseBindingSchema = require("../schemas/venueTargetReleaseBinding.schema");
...
const VenueReleaseSchema = new Schema({
  venueId: { type: Schema.Types.ObjectId, ref: "Venue", required: true, index: true },
  version: { type: Number, required: true, min: 1 },
  basedOnReleaseId: { type: Schema.Types.ObjectId, ref: "VenueRelease", default: null },
  layoutRevisionId: { type: Schema.Types.ObjectId, ref: "LayoutRevision", required: true, index: true },
  targetBindings: { type: [VenueTargetReleaseBindingSchema], default: [] },
  preVisitInformation: { type: [{ type: String, trim: true }], default: [] },
...
VenueReleaseSchema.index({ venueId: 1, version: 1 }, { unique: true });
VenueReleaseSchema.index({ venueId: 1, status: 1, version: -1 });

module.exports = mongoose.model("VenueRelease", VenueReleaseSchema);
