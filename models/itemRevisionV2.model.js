...
ItemRevisionV2Schema.index({ "presentationVariants.representations.locale": 1 });
ItemRevisionV2Schema.index({ "selectionSignals.definitionId": 1 });
module.exports = mongoose.model("ItemRevisionV2", ItemRevisionV2Schema);
