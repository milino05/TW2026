...
const semanticGraphRoutes = require("./routes/semanticGraphs.routes");
...
const synchronizedVisitSessionRoutes = require("./routes/synchronizedVisitSessions.routes");
...
app.use("/api", semanticGraphRoutes);
...
app.use("/api", synchronizedVisitSessionRoutes);
